...
function ExpenseItem({expense,onDeleteExpense,onUpdateExpense}) {
  ...
  return (
    <div style={itemStyle}>
        ...
        isEditing ? (
            <>
            <button style={submitButtonStyle} onClick={handleUpdateExpense}>Update </button>

            <button style={submitDeleteStyle}  onClick={handleCancelEdit}>Cancel </button>
            </>
        ):(
            <>
            <button style={submitButtonStyle} onClick={handleEditClick}>Edit </button>
            <button style={submitDeleteStyle} onClick={()=>onDeleteExpense(expense.id)}> Delete</button>
            </>
        )
        }
    </div>
